...
Citizen.CreateThread(function()
    while true do
        ...
        RageUI.IsVisible(RMenu:Get('hs0_planelocation', 'main'), true, true, true, function()
            ...
            RageUI.Button("Luxor", nil, {RightLabel = "~g~50000$"},true, function(Hovered, Active, Selected)
            if (Selected) then   
            ...
            RageUI.Button("Dodo plane", nil, {RightLabel = "~g~25000$"},true, function(Hovered, Active, Selected)
            if (Selected) then   
